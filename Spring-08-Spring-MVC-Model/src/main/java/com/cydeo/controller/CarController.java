...
//        the param match with name
//        System.out.println("make = " + make);
        model.addAttribute("make",make); //get from browser and print in html dynamically
        model.addAttribute("year",year); //get from browser and print in html dynamically
